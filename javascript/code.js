...
window.addEventListener('load',function(){
    ...
    rangeMusic.value = 0
    displayAlert('Website thuộc bản quyền của Crodic Crystal. Các chức năng hoạt động: Tìm kiếm thêm bài nhạc, click vào nhạc bên ngoài, play/pause/next/prev/random/infinity, chuyển bài bằng list Mini. AI đã hoạt động')
})
